...
function LanguageHelper(){
     ...
     const Arrow = document.body.className 
     === 'de'? LanguageHelperCss.deArrow : LanguageHelperCss.enArrow;
  return (
      <div className={LanguageHelperCss.Container}>
          <img src={arrow} className={Arrow} alt="an Arrow Pointing at the change Language RadioButtons"/>
